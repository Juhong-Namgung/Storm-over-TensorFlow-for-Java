...
public class noSetGroupingPerfTopo {
    ...
    private static StormTopology getTopology(Map conf) {
        ...
        // 1 -  Setup Spout   --------
        FirstSpout spout = new FirstSpout("/home/team1/juhong/kepco/tensorflowforjava/data/",  Helper.getInt(conf, "message.interval", 50));
